...
% 
% 
%     mask_img_savePath = fullfile(savePath, 'masks');  % Example directory
% 
...
% imwrite(combinedImage, mask_img_saveImagePath);
    ...
    % Save plots 
    plot_save_path = fullfile(savePath, 'linearity_check');
...
save_csv_file_single_row = fullfile(savePath, 'rgb_depth_bc.csv');
...
depth_vs_bc = readtable(fullfile(savePath, 'rgb_depth_bc.csv'));
...
% Save the figure
backscatter_plot_file_name = fullfile(savePath, 'backscatter_vs_distance.png');
