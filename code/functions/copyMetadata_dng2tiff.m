function copyMetadata_dng2tiff(dngPath, destinationPath)
...
for i = 1:numel(files)
    ...
    % Change destination file extension to .tif instead of .jpg
    saveFilePath = fullfile(destinationPath, [files(i).name(1:end-4), '.tif']);
