...
function [I,shortName,outputFilePath] = dng2tiff_pg(folders, stage)
if nargin < 3
    stage = 4;
end
cd(fullfile('.','camera-pipeline-nonUI-master/'));
...
dngPath = folders.dngFolder;
tiffSavePath = folders.uncorrectedTiffFolder;
